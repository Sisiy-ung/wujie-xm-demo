...
import { defineComponent, getCurrentInstance, h, onMounted, watch, onBeforeUnmount } from 'vue';
...
var wujie = defineComponent({
    ...
    setup: function setup(props) {
        ...
        var handlerEmit = function(event) {
            ...
            var _instance;
            instance === null || instance === void 0 ? void 0 : (_instance = instance).emit.apply(_instance, [
                event
