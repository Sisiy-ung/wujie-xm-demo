      ...
      setTimeout(function () {
        ...
        if (useObjectURL) {
          ...
          var _loop = function loop2() {
            ...
            if (iframeWindow.location.href === href) setTimeout(_loop, 1);else resolve();
          };
          _loop();
          return;
        }
...
var _ref2 = function () {
    ...
    var prevURL = "";
    var getSandboxEmptyPageURL = function getSandboxEmptyPageURL() {
      if (disabled) return "";
    ...
    var disableSandboxEmptyPageURL = function disableSandboxEmptyPageURL() {
      disabled = true;
      try {
  ...
  getSandboxEmptyPageURL = _ref3[0],
  disableSandboxEmptyPageURL = _ref3[1];
